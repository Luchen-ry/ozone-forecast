...
- 日志文件：delivery/logs/diffstg_advanced/diffstg_F1_pm10_p6_l24_s42.log
...
MAPE 仅 83.89%，远低于 O3（470%）和 PM2.5（124%），因 PM10 数值普遍较大，分母效应使 MAPE 更稳定。
三污染物对比结论：O3 预测难度最大（归一化 RMSE 8.72%），因光化学反应对气象条件敏感；
