...
- 学生：陈璐
- 日期：2026-07-17
- 实验编号：g3_diffstg_F15_p3_l24_s42
- 模型：DiffSTG（外部基线）
...
- 日志文件：logs/diffstg_F15/diffstg_air_n95_F15_noleak_p3_rerun.log
...
重跑版本：237 epochs 充分训练。相比旧版（15 epochs, MAE=21.15）大幅改善，验证 MAE 稳定下降。
...
相比 PE-DiffWaveNet pre_len=3（见 pedw_F15 目录），DiffSTG F=15 误差仍显著更高，
