...
- 学生：cl
- 日期：2026-07-17
- 实验编号：g3_diffstg_F15_p1_l24_s42
- 模型：DiffSTG（外部基线）
...
- 日志文件：logs/diffstg_F15/diffstg_air_n95_F15_noleak_p1_rerun.log
...
重跑版本：lr=0.001, early_stop=30。51 epochs 收敛，相比旧版（lr=0.002, es=10, 13 epochs, MAE=18.86）大幅改善。
...
相比 PE-DiffWaveNet pre_len=1（见 pedw_F15 目录），DiffSTG F=15 误差仍显著更高，
