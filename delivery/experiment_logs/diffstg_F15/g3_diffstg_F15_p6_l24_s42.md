...
- 学生：cl
- 日期：2026-07-17
- 实验编号：g3_diffstg_F15_p6_l24_s42
- 模型：DiffSTG（外部基线）
...
- 日志文件：logs/diffstg_F15/diffstg_air_n95_F15_noleak_p6_rerun.log

## 指标

| RMSE | MAE | MAPE | Peak RMSE | Step6 RMSE |
| --- | --- | --- | --- | --- |
| 31.55 | 24.83 | 350.4 |  | 31.55 |

best_epoch: 196

## 现象和结论

重跑版本：196 epochs 充分训练。相比旧版（12 epochs 早停, MAE=26.32）改善，验证 MAE 震荡问题被 early_stop=30 解决。
...
相比 PE-DiffWaveNet pre_len=6（见 pedw_F15 目录），DiffSTG F=15 误差仍显著更高，
