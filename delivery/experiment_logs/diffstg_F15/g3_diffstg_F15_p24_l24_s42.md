...
- 学生：cl
- 日期：2026-07-17
- 实验编号：g3_diffstg_F15_p24_l24_s42
- 模型：DiffSTG（外部基线）
...
- 日志文件：logs/diffstg_F15/diffstg_air_n95_F15_noleak_p24.log

## 指标

| RMSE | MAE | MAPE | Peak RMSE | Step6 RMSE |
| --- | --- | --- | --- | --- |
| 33.52 | 27.11 | 406.3 |  | 33.52 |

best_epoch: 46

## 现象和结论

保留原版（未重跑）：46 epochs 充分收敛，best_epoch=35。验证 MAE 从 31 稳步降至 28.7，训练充分。相比 p12 的 33 epochs 反而更优，因为 p24 训练更稳定。
...
相比 PE-DiffWaveNet pre_len=24（见 pedw_F15 目录），DiffSTG F=15 误差仍显著更高，
